...
与之相对的是事前编译（ahead-of-time compilation，简称AOT），也叫*静态编译*（static compilation）。
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1glwnozn0ojj30bt09yjry.jpg)
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1glwnoybw9jj30cj05swew.jpg)
...
1、只被调用一次，例如**类的构造器**（class initializer，\<clinit>()）
2、没有循环
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1glwnov2g8kj30ec0h30tb.jpg)

### 回边计数器

它的作用就是统计一个方法中*循环体*代码执行的次数，在字节码中遇到控制流向后跳转的指令称为“回边”。

![img](https://tva1.sinaimg.cn/large/0081Kckwgy1glwnotnwybj30e20iv0tc.jpg)
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1glwnor03plj30dw09d0t7.jpg)
