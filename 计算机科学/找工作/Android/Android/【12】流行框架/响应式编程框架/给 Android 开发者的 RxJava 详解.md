...
[https://github.com/ReactiveX/RxJava](https://link.jianshu.com/?t=https://github.com/ReactiveX/RxJava)
[https://github.com/ReactiveX/RxAndroid](https://link.jianshu.com/?t=https://github.com/ReactiveX/RxAndroid)
引入依赖：
...
![img](https://upload-images.jianshu.io/upload_images/2075640-a4351b98899d0ecb.jpg?imageMogr2/auto-orient/strip|imageView2/2/w/148)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr7gq85fj30fz03rglk.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr7hoapzj30ga03pdfs.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr7eulbej30gn04qt8q.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr7ci7eqj30lk0a8jrp.jpg)

关系静图

或者可以看动图：

![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr7b50gug30ig08wnag.gif)
...
![img](https://upload-images.jianshu.io/upload_images/2075640-1520d8e05e4a598c.jpg?imageMogr2/auto-orient/strip|imageView2/2/w/150)
...
- `map()`: 事件对象的直接变换，具体功能上面已经介绍过。它是 RxJava 最常用的变换。 map() 的示意图：
  ...
  ![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr77d8l0j30hw0eaweq.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr75iyabj30hg0dymxk.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr735l9ej30h40d1mxp.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr72fncog30go0cz4qp.gif)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr70z1cyj30h30hlab0.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr6y0bcjj30ha0d7dgf.jpg)

subscribeOn() 原理

`observeOn()` 原理图：

![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr6w5vocj30hj0cyq3i.jpg)
...
![img](https://tva1.sinaimg.cn/large/008eGmZEly1gmyr6uvo1hj30hd0hzjsq.jpg)
...
[Retrofit](https://link.jianshu.com/?t=https://github.com/square/retrofit) 除了提供了传统的 `Callback` 形式的 API，还有 RxJava 版本的 Observable 形式 API。下面我用对比的方式来介绍 Retrofit 的 RxJava 版 API 和传统版本的区别。
...
[RxBinding](https://link.jianshu.com/?t=https://github.com/JakeWharton/RxBinding) 是 Jake Wharton 的一个开源库，它提供了一套在 Android 平台上的基于 RxJava 的 Binding API。所谓 Binding，就是类似设置 `OnClickListener` 、设置 `TextWatcher` 这样的注册绑定对象的 API。
...
[RxBus](https://link.jianshu.com/?t=https://github.com/AndroidKnife/RxBus) 名字看起来像一个库，但它并不是一个库，而是一种模式，它的思想是使用 RxJava 来实现了 EventBus ，而让你不再需要使用 `Otto` 或者 GreenRobot 的 `EventBus`。至于什么是 RxBus，可以看这篇文章。顺便说一句，Flipboard 已经用 RxBus 替换掉了 `Otto` ，目前为止没有不良反应。
...
原文链接：[http://gank.io/post/560e15be2dca930e00da1083](https://link.jianshu.com/?t=http://gank.io/post/560e15be2dca930e00da1083)



作者：Brian512
链接：https://www.jianshu.com/p/706ab1932070
来源：简书
