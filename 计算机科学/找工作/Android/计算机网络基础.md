...
## 缓存机制
![1670BBD4-93B7-49BF-A068-1F1B387BBEA2](https://tva1.sinaimg.cn/large/0081Kckwly1glpphq9z1qj30pu0s7tat.jpg)
...
| max-age | 缓存的过期时间
| no-cache | 【需要使用对比缓存来验证缓存数据，**如果服务端确认资源没有更新，则返回304**，】，如果有更新，则返回最新的资源。做对比缓存与 Etag 有关。
...
- **二进制格式**：http1.x 是文本协议，而 http2.0 是**二进制以帧为基本单位**，是一个二进制协议，一帧中除了包含数据外同时还包含该帧的标识：Stream Identifier，即**标识了该帧属于哪个 request**，使得网络传输变得十分灵活。
<br>
...
![image-20201216000524496](https://tva1.sinaimg.cn/large/0081Kckwly1glozm5klx1j30yf0u0164.jpg)
