...
https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_60%E3%80%81%E5%A6%82%E4%BD%95%E9%AB%98%E6%95%88%E7%9A%84%E4%BD%BF%E7%94%A8-mysql-%E6%98%BE%E5%BC%8F%E9%9A%8F%E6%9C%BA%E6%B6%88%E6%81%AF

## 基础

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_1、关系型和非关系型数据库的区别)1、关系型和非关系型数据库的区别？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_2、详细说一下一条-mysql-语句执行的步骤)2、详细说一下一条 MySQL 语句执行的步骤
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#索引相关)索引相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_3、mysql-使用索引的原因)3、MySQL 使用索引的原因？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_4、索引的三种常见底层数据结构以及优缺点)4、索引的三种常见底层数据结构以及优缺点
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_5、索引的常见类型以及它是如何发挥作用的)5、索引的常见类型以及它是如何发挥作用的？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_6、myisam-和-innodb-实现-b-树索引方式的区别是什么)6、MyISAM 和 InnoDB 实现 B 树索引方式的区别是什么？

- InnoDB 存储引擎：B+ 树索引的叶子节点保存数据本身，其数据文件本身就是索引文件。
- MyISAM 存储引擎：B+ 树索引的叶子节点保存数据的物理地址，叶节点的 data 域存放的是数据记录的地址，索引文件和数据文件是分离的。

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_7、innodb-为什么设计-b-树索引)7、InnoDB 为什么设计 B+ 树索引？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_8、什么是覆盖索引和索引下推)8、什么是覆盖索引和索引下推？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_9、哪些操作会导致索引失效)9、哪些操作会导致索引失效？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_10、字符串加索引)10、字符串加索引
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#日志相关)日志相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_11、mysql-的-change-buffer-是什么)11、MySQL 的 change buffer 是什么？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_12、mysql-是如何判断一行扫描数的)12、MySQL 是如何判断一行扫描数的？

- MySQL 在真正开始执行语句之前，并不能精确地知道满足这个条件的记录有多少条。
- 而只能根据统计信息来估算记录数。这个统计信息就是索引的“区分度。

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_13、mysql-的-redo-log-和-binlog-区别)13、MySQL 的 redo log 和 binlog 区别？

![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h5o0fut8zrj20vo0u0dhb.jpg)

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_14、为什么需要-redo-log)14、为什么需要 redo log？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_15、为什么-redo-log-具有-crash-safe-的能力-是-binlog-无法替代的)15、为什么 redo log 具有 crash-safe 的能力，是 binlog 无法替代的？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_16、当数据库-crash-后-如何恢复未刷盘的数据到内存中)16、当数据库 crash 后，如何恢复未刷盘的数据到内存中？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_17、redo-log-写入方式)17、redo log 写入方式？
...
![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h5o0fxgrfjj21180qon11.jpg)
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_18、redo-log-的执行流程)18、redo log 的执行流程?
...
![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h5o0fv2qdrj21060oi0ui.jpg)
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_19、binlog-的概念是什么-起到什么作用-可以保证-crash-safe-吗)19、binlog 的概念是什么，起到什么作用， 可以保证 crash-safe 吗?
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_20、什么是两阶段提交)20、什么是两阶段提交？

MySQL 将 redo log 的写入拆成了两个步骤：prepare 和 commit，中间再穿插写入binlog，这就是"两阶段提交"。

![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h5o0fvm5z3j20wv0u077f.jpg)
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_21、mysql-怎么知道-binlog-是完整的)21、MySQL 怎么知道 binlog 是完整的?
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_22、什么是-wal-技术-有什么优点)22、什么是 WAL 技术，有什么优点？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_23、binlog-日志的三种格式)23、binlog 日志的三种格式
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_24、redo-log日志格式)24、redo log日志格式

![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h5o0fw7fkoj20vq0nsmy2.jpg)
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_25、原本可以执行得很快的-sql-语句-执行速度却比预期的慢很多-原因是什么-如何解决)25、原本可以执行得很快的 SQL 语句，执行速度却比预期的慢很多，原因是什么？如何解决？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_26、innodb-数据页结构)26、InnoDB 数据页结构
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#数据相关)数据相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_27、mysql-是如何保证数据不丢失的)27、MySQL 是如何保证数据不丢失的？

- 只要redolog 和 binlog 保证持久化磁盘就能确保MySQL异常重启后回复数据
- 在恢复数据时，redolog 状态为 commit 则说明 binlog 也成功，直接恢复数据；如果 redolog 是 prepare，则需要查询对应的 binlog事务是否成功，决定是回滚还是执行。

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_28、误删数据怎么办)28、误删数据怎么办？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_29、drop、truncate-和-delete-的区别)29、drop、truncate 和 delete 的区别
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_30、在-mysql-中有两个-kill-命令)30、在 MySQL 中有两个 kill 命令
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_31、如何理解-mysql-的边读边发)31、如何理解 MySQL 的边读边发
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_32、mysql-的大表查询为什么不会爆内存)32、MySQL 的大表查询为什么不会爆内存？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_33、mysql-临时表的用法和特性)33、MySQL 临时表的用法和特性
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_34、mysql-存储引擎介绍-innodb、myisam、memory)34、MySQL 存储引擎介绍（InnoDB、MyISAM、MEMORY）
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_35、都说-innodb-好-那还要不要使用-memory-引擎)35、都说 InnoDB 好，那还要不要使用 MEMORY 引擎？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_36、如果数据库误操作-如何执行数据恢复)36、如果数据库误操作, 如何执行数据恢复?

数据库在某个时候误操作，就可以找到距离误操作最近的时间节点的bin log，重放到临时数据库里，然后选择误删的数据节点，恢复到线上数据库。

## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#主从备份相关)主从备份相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_37、mysql-是如何保证主备同步)37、MySQL 是如何保证主备同步？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_38、什么是主备延迟)38、什么是主备延迟
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_39、为什么要有多线程复制策略)39、为什么要有多线程复制策略？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_40、mysql-的并行策略有哪些)40、MySQL 的并行策略有哪些？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_41、mysql的一主一备和一主多从有什么区别)41、MySQL的一主一备和一主多从有什么区别？

在一主一备的双 M 架构里，主备切换只需要把客户端流量切到备库；而在一主多从架构里，主备切换除了要把客户端流量切到备库外，还需要把从库接到新主库上。

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_42、主库出问题如何解决)42、主库出问题如何解决?
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_43、mysql-读写分离涉及到过期读问题的几种解决方案)43、MySQL 读写分离涉及到过期读问题的几种解决方案?
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_44、mysql的并发链接和并发查询有什么区别)44、MySQL的并发链接和并发查询有什么区别？
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#性能相关)性能相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_45、短时间提高-mysql-性能的方法)45、短时间提高 MySQL 性能的方法
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_46、为什么-mysql-自增主键-id-不连续)46、为什么 MySQL 自增主键 ID 不连续？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_47、innodb-为什么要用自增-id-作为主键)47、InnoDB 为什么要用自增 ID 作为主键？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_48、如何最快的复制一张表)48、如何最快的复制一张表？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_49、grant-和-flush-privileges语句)49、grant 和 flush privileges语句
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_50、要不要使用分区表)50、要不要使用分区表？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_51、join-用法)51、join 用法
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_52、mysql-有哪些自增id-各自场景是什么)52、MySQL 有哪些自增ID？各自场景是什么？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_53、xid-在-mysql-内部是怎么生成的呢)53、Xid 在 MySQL 内部是怎么生成的呢？
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#锁相关)锁相关

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_54、说一下-mysql-的锁)54、说一下 MySQL 的锁
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_55、什么是幻读)55、什么是幻读？
...
## [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#其它为什么系列)其它为什么系列

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_56、为什么-mysql-会抖一下)56、为什么 MySQL 会抖一下？

- 脏页会被后台线程自动 flush，也会由于数据页淘汰而触发 flush，而刷脏页的过程由于会占用资源，可能会让你的更新和查询语句的响应时间长一些。

### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_57、为什么删除了表-表文件的大小还是没变)57、为什么删除了表，表文件的大小还是没变？
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_58、count-实现方式以及各种-count-对比)58、`count(*)`实现方式以及各种 count 对比
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_59、orderby-排序内部原理)59、orderby 排序内部原理
...
### [#](https://tobebetterjavaer.com/sidebar/herongwei/mysql.html#_60、如何高效的使用-mysql-显式随机消息)60、如何高效的使用 MySQL 显式随机消息
