...
# [Sql优化的15个小技巧](https://www.cnblogs.com/karkash/p/15746136.html)

从15个方面，分享了sql优化的一些小技巧，希望对你有所帮助

![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h1zpbozs99j20h70nzjsk.jpg)
...
### 2. 用union all代替union
 ...
 我们都知道sql语句使用`union`关键字后，可以获取排重后的数据。而如果使用`union all`关键字，可以获取所有数据，包含重复的数据。
...
![img](https://img2020.cnblogs.com/blog/275839/202112/275839-20211229184751042-395739657.png)

 

 通过这几列可以判断索引使用情况，执行计划包含列的含义如下图所示：

![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h1zpbl5o3uj20hq0cot98.jpg)

 

 下面说说索引失效的常见原因：

 ![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h1zpbkomyyj20hq0cot98.jpg)
