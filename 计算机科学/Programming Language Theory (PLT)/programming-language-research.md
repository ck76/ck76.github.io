...
[Research](https://github.com/imteekay/programming-language-research/blob/master/research) on programming languages, compilers, functional programming, devtools.

## Table of Contents



- [Courses](https://github.com/imteekay/programming-language-research#courses)
- [Books](https://github.com/imteekay/programming-language-research#books)
- [Learning Paths](https://github.com/imteekay/programming-language-research#learning-paths)
- [Experiments](https://github.com/imteekay/programming-language-research#experiments)
- [Papers](https://github.com/imteekay/programming-language-research#papers)
- [Programming Language Design / PLT](https://github.com/imteekay/programming-language-research#programming-language-design--plt)
- [Compiler](https://github.com/imteekay/programming-language-research#compiler)
- [PL Paradigms](https://github.com/imteekay/programming-language-research#pl-paradigms)
- [Interpreter](https://github.com/imteekay/programming-language-research#interpreter)
- [PL Research](https://github.com/imteekay/programming-language-research#pl-research)
- [Type System](https://github.com/imteekay/programming-language-research#type-system)
- [Parsers](https://github.com/imteekay/programming-language-research#parsers)
- [Backend](https://github.com/imteekay/programming-language-research#backend)
- [Program Synthesis](https://github.com/imteekay/programming-language-research#program-synthesis)
- Language Learnings
  - [TypeScript](https://github.com/imteekay/programming-language-research#typescript)
  - [Ecmascript](https://github.com/imteekay/programming-language-research#ecmascript)
  - [Rust](https://github.com/imteekay/programming-language-research#rust)
  - [Python](https://github.com/imteekay/programming-language-research#python)
  - [OCaml](https://github.com/imteekay/programming-language-research#ocaml)
- [Browser](https://github.com/imteekay/programming-language-research#browser)
- [Web UI](https://github.com/imteekay/programming-language-research#web-ui)
- Careers
  - [Jobs](https://github.com/imteekay/programming-language-research#jobs)
  - [Schools](https://github.com/imteekay/programming-language-research#schools)
- [People in PL](https://github.com/imteekay/programming-language-research#people-in-pl)
...
- [📚 SICP — Structure and Interpretation of Computer](https://github.com/imteekay/programming-language-research/blob/master/research/books/sicp)
...
- [PLR & Compiler Learning Path](https://github.com/imteekay/programming-language-research/blob/master/learning-path.md)
...
- [An interpreter for the Lox programming language](https://github.com/imteekay/programming-language-research/blob/master/research/experiments/lox.ts)
...
- [📜 How Statically-Typed Functional Programmers Write Code](https://github.com/imteekay/programming-language-research/blob/master/research/papers/how-statically-typed-functional-programmers-write-code)
...
- [🎥 Quick look at the TypeScript Compiler API](https://www.youtube.com/watch?v=AnjfW633e8o‎.‎dev)
...
- [🎥 "Hindley-Milner Type Inference — Part 1](https://www.youtube.com/watch?v=cQf_6NsLp80&ab_channel=AdamDoupé)
- [🎥 "Hindley-Milner Type Inference — Part 2](https://www.youtube.com/watch?v=xJXcZp2vgLs&list=PLK06XT3hFPzilgF1mi_hHqcXO1-o_8OEe&index=37&ab_channel=AdamDoupé)
...
- [Chromium Engineer at Browser Company](https://github.com/imteekay/programming-language-research/blob/master/careers/chromium-engineer-browser-company.pdf)
- [Senior Software Engineer at Mozilla Corporation](https://github.com/imteekay/programming-language-research/blob/master/careers/mozilla-firefox-senior-software-engineer.pdf)
- [JavaScript Virtual Machine Compiler Engineer at Apple](https://github.com/imteekay/programming-language-research/blob/master/careers/javascript-virtual-machine-compiler-engineer.pdf)
- [Compiler Jobs](https://mgaudet.github.io/CompilerJobs)
- [Swift Type System Engineer](https://github.com/imteekay/programming-language-research/blob/master/careers/swift-type-system-engineer-apple.pdf)
- [Compiler Engineer](https://github.com/imteekay/programming-language-research/blob/master/careers/woven-by-toyota.pdf)
- [Groq Compiler Engineer](https://github.com/imteekay/programming-language-research/blob/master/careers/groq-compiler-engineer.pdf)
- [Modular AI Compiler Engineer](https://github.com/imteekay/programming-language-research/blob/master/careers/modular-ai-compiler-engineer.pdf)
